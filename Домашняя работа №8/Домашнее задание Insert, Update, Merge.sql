...
--добавлю туда нову, которой нет в табличке sales.Customers_v2, но при этом изменю у одной уже существующей 
--2. Далеесделаю мердж, где добавится 1строка а остальные просто сравняться и остануться таковыми. 
